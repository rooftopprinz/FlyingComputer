...
src.add_include_paths(['src/', 'FlyInterface/', 'Logless/src/', 'BFC/include/'])
src.set_src_dir('src/')
...
test.add_include_paths(['gtest/', 'src/', 'FlyInterface/', 'test/', 'Logless/src', 'BFC/include/'])
...
flydb.add_include_paths(['src/', 'FlyInterface/', 'Logless/src', 'BFC/include/'])
...
puller.add_include_paths(['SCT/', 'FlyInterface/', 'Logless/src', 'BFC/include/', 'FlyDbClient/'])
...
pusher.add_include_paths(['SCT/', 'FlyInterface/', 'Logless/src', 'BFC/include/', 'FlyDbClient/'])
